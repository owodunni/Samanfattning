...
\item \[r = \sum\limits_{i=1}^n r\hat{e}^r_i \]

\item \[ v = \frac{dr}{dt} = \sum\limits_{i=1}^n \dot{r}\hat{e}^r_i \]

\item \[ a = \frac{d^2r}{dt^2} = \sum\limits_{i=1}^n \ddot{r}\hat{e}^r_i \]
...
%\item $\hat{n} = \frac{\frac{d\hat{t}{ds}}{\abs{\frac{d\hat{t}{ds}}}}$
